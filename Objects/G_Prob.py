...
from G_Models import MILP_Model, MILP_Solve,So_Model,So_Solve
...
class GA_LP:
    ...
    def __init__(self,MetNet:MetabolicNetwork=None,K:int=None):
        self.metnet = MetNet
        self.K = K
        self.model = So_Model(self.metnet)
    ...
    def calc_obj(self,individual):
        individual.biomass, individual.chemical = So_Solve(network=self.metnet,model=self.model,y=individual.Gene)
