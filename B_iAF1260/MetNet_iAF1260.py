...
biomass = rxn.index('BIOMASS_Ec_iAF1260_core_59p81M')
...
MN_iaf1260 = Metabolic_Network(S=S,LB=LB,UB=UB,Rxn=rxn,Met=met,KO=ko,Name=bacteria,biomass=biomass,chemical=chemical) 